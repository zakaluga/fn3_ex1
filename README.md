...
(отсутствует информация о зарегистрированных учебных предметах).
   ...
   3. Выполняется регистрация двух разных учебных предметов (каждого специального типа) и двух не учебных.
   4. Программа выводит меню для оперирования с информацией: 
      - можно просмотреть список зарегистрированных предметов и информацию связанную с ними (каждым по отдельности) с форматированием, 
