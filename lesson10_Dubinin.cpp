...
/*bool operator == (const Computers & other)
{
    return this->serial_number == other.serial_number && this->graph_card == other.graph_card &&
this->cpu == other.cpu;
...
int main()
{
    ...
    while (first_choise != 6)
    {
        ...
        case 1:
        {
            ...
            cout << "1.4 Delete recurring elements" << endl;
            cout << "1.5 Get back to main menu" << endl;
            Empty_Print();
            string choisestr2;
            cin >> choisestr2;
            ...
            break;
нужно ли вносить функцию изменения полей внутрь класа (делать методом класса)?
            case 3:
            {
            ...
            case 4:
            {
                ...
                List_computer.unique();
                cout << "Cleaning from repetitions is done" << endl;
                cout << "Updated computer's list: " << endl;
                Computer_List_Print(List_computer);
            }
